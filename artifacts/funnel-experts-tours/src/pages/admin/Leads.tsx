...
import type { ListLeadsStatus, UpdateLeadStatusBodyStatus } from "@workspace/api-client-react/src/generated/api.schemas";

export default function LeadsAdmin() {
  // Simple mock auth for the sake of the exercise
  ...
  const { data: leadsRes, isLoading } = useListLeads(
    ...
    return (
      <div className="min-h-screen bg-background flex flex-col items-center justify-center p-4">
        <div className="bg-card p-8 border border-white/10 shadow-2xl max-w-md w-full text-center">
          ...
          <p className="text-gray-400 text-sm mb-6">Enter password to view leads (hint: admin123)</p>
                  ...
                  <tr key={lead.id} className="hover:bg-white/[0.02] transition-colors">
                    ...
                    <td className="px-6 py-5 align-top">
                      ...
                      <div className="text-gray-400 text-xs">
                        {lead.destination && <span className="uppercase">{lead.destination} • </span>}
